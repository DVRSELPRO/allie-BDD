                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list" style="display: <?php echo ($mSesion ? "block" : "none")?>;">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="assets/images/users/default.png" alt="user" class="rounded-circle"> <span class="ml-1">
                                        <?php
                                        if ($mSesion->getTipo_persona() == "Moral") {
                                            $x = mb_convert_case(mb_strtolower($mSesion->getRazon_social(), "utf-8"), MB_CASE_TITLE, 'UTF-8');
                                            $arr = explode(" ", $x);
                                            if(isset($arr[0])){
                                                echo $arr[0];
                                            }else{
                                        ...
                                        } else if ($mSesion->getTipo_persona() == "Fisica") {
                                            $x = mb_convert_case(mb_strtolower($mSesion->getNombreempleado(), "utf-8"), MB_CASE_TITLE, 'UTF-8');
                                            $arr = explode(" ", $x);
                                            if(isset($arr[0])){
                                                echo $arr[0];
                                            }else{
...
<!--                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    ...
                                    <!-- item-->
                                    <a href="index.php?action=close" class="dropdown-item notify-item">
