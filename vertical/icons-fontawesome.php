                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div>
                                <div class="card-box">
                                    <section>
                                        <h4 class="page-header header-title mb-4">41 New Icons in 4.7 <span class="badge badge-success">New</span></h4>
                                    ...
                                    <section>
                                        <h4 class="header-title mb-4 mt-5">30 New Icons in 4.6.3 </h4>
                                        <div class="icon-list-demo row">
                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-american-sign-language-interpreting"></i>fa fa-american-sign-language-interpreting</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-asl-interpreting"></i>fa fa-asl-interpreting</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-assistive-listening-systems"></i>fa fa-assistive-listening-systems</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-audio-description"></i>fa fa-audio-description</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-blind"></i>fa fa-blind</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-braille"></i>fa fa-braille</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-deaf"></i>fa fa-deaf</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-deafness"></i>fa fa-deafness</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-envira"></i>fa fa-envira</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-first-order"></i>fa fa-first-order</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-gitlab"></i>fa fa-gitlab</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-glide"></i>fa fa-glide</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-glide-g"></i>fa fa-glide-g</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-hard-of-hearing"></i>fa fa-hard-of-hearing</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-low-vision"></i>fa fa-low-vision</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-pied-piper"></i>fa fa-pied-piper</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-question-circle-o"></i>fa fa-question-circle-o</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-sign-language"></i>fa fa-sign-language</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-signing"></i>fa fa-signing</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-snapchat"></i>fa fa-snapchat</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-snapchat-ghost"></i>fa fa-snapchat-ghost</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-snapchat-square"></i>fa fa-snapchat-square</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-themeisle"></i>fa fa-themeisle</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-universal-access"></i>fa fa-universal-access</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-viadeo"></i>fa fa-viadeo</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-viadeo-square"></i>fa fa-viadeo-square</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-volume-control-phone"></i>fa fa-volume-control-phone</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-wheelchair-alt"></i>fa fa-wheelchair-alt</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-wpbeginner"></i>fa fa-wpbeginner</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-wpforms"></i>fa fa-wpforms</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-yoast"></i>fa fa-yoast</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-font-awesome"></i>fa fa</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-font-awesome"></i>fa fa-font-awesome</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-google-plus-official"></i>fa fa-google-plus-official</div>

                                        </div>
                                    </section>

                                    <section>
                                        <h4 class="header-title mb-4 mt-5">20 New Icons in 4.5 </h4>
                                        <div class="icon-list-demo row">
                                    ...
                                    <section>
                                        <h4 class="header-title mb-4 mt-5">66 Icons in 4.4 </h4>
                                        <div class="icon-list-demo row">
                                    ...
                                    <section>
                                        <h4 class="header-title mb-4 mt-5">40 Icons in 4.3 </h4>
                                    ...
                                    <section id="new-icons">
                                        <h4 class="header-title mb-4 mt-5">40 Icons in 4.2</h4>
                                        <div class="icon-list-demo row">
                                    ...
                                    <section id="web-application">
                                        <h4 class="header-title mb-4 mt-5">Web Application</h4>
                                        <div class="icon-list-demo row">
                                    ...
                                    <section id="file-type">
                                        <h4 class="header-title mb-4 mt-5">File Type Icons</h4>
                                    ...
                                    <section id="spinner">
                                        <h4 class="header-title mb-4 mt-5">Spinner Icons</h4>
                                        ...
                                        <div class="row icon-list-demo">
                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-spin fa-circle-o-notch" style="width: auto;height: auto; line-height: 1px; margin-right: 10px;"></i> fa-circle-o-notch</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-spin fa-cog" style="width: auto;height: auto; line-height: 1px; margin-right: 10px;"></i> fa-cog</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-spin fa-gear" style="width: auto;height: auto; line-height: 1px; margin-right: 10px;"></i> fa-gear <span class="text-muted">(alias)</span>
                                            </div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-spin fa-refresh" style="width: auto;height: auto; line-height: 1px; margin-right: 10px;"></i> fa-refresh</div>

                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-spin fa-spinner" style="width: auto;height: auto; line-height: 1px; margin-right: 10px;"></i> fa-spinner</div>

                                        </div>
                                    </section>

                                    <section id="form-control">
                                        <h4 class="header-title mb-4 mt-5">Form Control Icons</h4>
                                    ...
                                    <section id="currency">
                                        <h4 class="header-title mb-4 mt-5">Currency Icons</h4>
                                    ...
                                    <section id="text-editor">
                                        <h4 class="header-title mb-4 mt-5">Text Editor Icons</h4>
                                    ...
                                    <section id="directional">
                                        <h4 class="header-title mb-4 mt-5">Directional Icons</h4>
                                    ...
                                    <section id="video-player">
                                        <h4 class="header-title mb-4 mt-5">Video Player Icons</h4>
                                    ...
                                    <section id="brand">
                                        <h4 class="header-title mb-4 mt-5">Brand Icons</h4>
                                    ...
                                    <section id="medical">
                                        <h4 class="header-title mb-4 mt-5">Medical Icons</h4>
