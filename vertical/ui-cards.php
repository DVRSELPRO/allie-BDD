            ...
            <div class="content">
                <div class="container-fluid">
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <div class="card m-b-30">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-custom waves-effect waves-light">Button</a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card m-b-30 text-white bg-pink">
                                <div class="card-body">
                                    <blockquote class="card-bodyquote">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                                            erat a ante.</p>
                            ...
                            <div class="card-columns">
                                ...
                                <div class="card m-b-30 card-body">
                                    <blockquote class="card-bodyquote mb-0">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                                            erat a ante.</p>
                                        <footer class="blockquote-footer text-muted font-13">Someone famous in <cite title="Source Title">Source Title</cite>
                                        </footer>
                                    </blockquote>
                                </div>
                                <div class="card m-b-30">
                                ...
                                <div class="card m-b-30 card-body card-inverse card-primary">
                                    <blockquote class="card-bodyquote mb-0">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                                            erat.</p>
