                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box p-5">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted mt-3">Why not try refreshing your page? or you can contact <a href="" class="text-dark"><b>Support</b></a></p>

                                <a class="btn btn-md btn-block btn-custom waves-effect waves-light mt-3" href="index.php"> Return Home</a>
                            </div>
