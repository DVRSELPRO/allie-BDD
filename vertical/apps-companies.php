                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-3">
                            <div class="company-card card-box">
                                ...
                                <h5 class="text-muted font-normal"><span class="float-right text-danger"><i class="mdi mdi-arrow-down"></i> 1.22%</span> Change(2d)</h5>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="company-card card-box">
                                ...
                                <h5 class="text-muted font-normal"><span class="float-right text-success"><i class="mdi mdi-arrow-up"></i> 8.51%</span> Change(1d)</h5>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="company-card card-box">
                                ...
                                <h5 class="text-muted font-normal"><span class="float-right text-success"><i class="mdi mdi-arrow-up"></i> 3.38%</span> Change(2d)</h5>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="company-card card-box">
                                ...
                                <h5 class="text-muted font-normal"><span class="float-right text-danger"><i class="mdi mdi-arrow-down"></i> 6.35%</span> Change(2d)</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-3">
                            <div class="company-card card-box">
                                ...
                                <h5 class="text-muted font-normal"><span class="float-right text-success"><i class="mdi mdi-arrow-up"></i> 0.51%</span> Change(1d)</h5>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="company-card card-box">
                                ...
                                <h5 class="text-muted font-normal"><span class="float-right text-success"><i class="mdi mdi-arrow-up"></i> 22.35%</span> Change(1d)</h5>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="company-card card-box">
                                ...
                                <h5 class="text-muted font-normal"><span class="float-right text-danger"><i class="mdi mdi-arrow-down"></i> 2.94%</span> Change(2d)</h5>
