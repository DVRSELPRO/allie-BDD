                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card-box">
                                ...
                                <div class="button-list">
                                    <button type="button" class="btn btn-primary waves-light waves-effect">Primary</button>
                                    <button type="button" class="btn btn-secondary waves-light waves-effect">Secondary</button>
                                    <button type="button" class="btn btn-success waves-light waves-effect">Success</button>
                                    <button type="button" class="btn btn-danger waves-light waves-effect">Danger</button>
                                    <button type="button" class="btn btn-warning waves-light waves-effect">Warning</button>
                                    <button type="button" class="btn btn-info waves-light waves-effect">Info</button>
                                    <button type="button" class="btn btn-light waves-effect">Light</button>
                                    <button type="button" class="btn btn-dark waves-light waves-effect">Dark</button>
                                    ...
                                    <button type="button" class="btn btn-custom waves-light waves-effect">Custom</button>
                                </div>
                                ...
                                <div class="button-list">
                                    <button type="button" class="btn btn-outline-primary waves-light waves-effect">Primary</button>
                                    <button type="button" class="btn btn-outline-secondary waves-light waves-effect">Secondary</button>
                                    <button type="button" class="btn btn-outline-success waves-light waves-effect">Success</button>
                                    <button type="button" class="btn btn-outline-danger waves-light waves-effect">Danger</button>
                                    <button type="button" class="btn btn-outline-warning waves-light waves-effect">Warning</button>
                                    <button type="button" class="btn btn-outline-info waves-light waves-effect">Info</button>
                                    <button type="button" class="btn btn-outline-light waves-effect">Light</button>
                                    <button type="button" class="btn btn-outline-dark waves-light waves-effect">Dark</button>
                                    ...
                                    <button type="button" class="btn btn-outline-custom waves-light waves-effect">Custom</button>
                                </div>

                                <h4 class="header-title m-t-50">Button-Rounded</h4>
                                <p class="text-muted m-b-25 font-14">Add <code>.btn-rounded</code> to default button to get rounded corners.</p>

                                <div class="button-list">
                                    <button type="button" class="btn btn-primary btn-rounded waves-light waves-effect">Primary</button>
                                    <button type="button" class="btn btn-secondary btn-rounded waves-light waves-effect">Secondary</button>
                                    <button type="button" class="btn btn-success btn-rounded waves-light waves-effect">Success</button>
                                    <button type="button" class="btn btn-danger btn-rounded waves-light waves-effect">Danger</button>
                                    <button type="button" class="btn btn-warning btn-rounded waves-light waves-effect">Warning</button>
                                    <button type="button" class="btn btn-info btn-rounded waves-light waves-effect">Info</button>
                                    <button type="button" class="btn btn-light btn-rounded waves-effect">Light</button>
                                    <button type="button" class="btn btn-dark btn-rounded waves-light waves-effect">Dark</button>
                                    ...
                                    <button type="button" class="btn btn-custom btn-rounded waves-light waves-effect">Custom</button>
                                </div>
                                ...
                                <div class="button-list">
                                    <button type="button" class="btn btn-outline-primary btn-rounded waves-light waves-effect">Primary</button>
                                    <button type="button" class="btn btn-outline-secondary btn-rounded waves-light waves-effect">Secondary</button>
                                    <button type="button" class="btn btn-outline-success btn-rounded waves-light waves-effect">Success</button>
                                    <button type="button" class="btn btn-outline-danger btn-rounded waves-light waves-effect">Danger</button>
                                    <button type="button" class="btn btn-outline-warning btn-rounded waves-light waves-effect">Warning</button>
                                    <button type="button" class="btn btn-outline-info btn-rounded waves-light waves-effect">Info</button>
                                    <button type="button" class="btn btn-outline-light btn-rounded waves-effect">Light</button>
                                    <button type="button" class="btn btn-outline-dark btn-rounded waves-light waves-effectmd">Dark</button>
                                    ...
                                    <button type="button" class="btn btn-outline-custom btn-rounded waves-light waves-effect">Custom</button>
                                </div>

                                <h4 class="header-title m-t-50">Button-Width</h4>
                        ...
                        <div class="col-lg-6">
                            <div class="card-box">
                                ...
                                <h4 class="header-title m-t-50">Icon Button</h4>
                                <p class="text-muted m-b-25 font-14">
                                    Icon only button.
                                </p>
                                ...
                                <h4 class="header-title m-t-50">Block Button</h4>
                                <p class="text-muted m-b-25 font-14">
                                ...
                                <h4 class="header-title m-t-50">Button Group</h4>
                                <p class="text-muted m-b-25 font-14">
